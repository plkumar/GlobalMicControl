...
// GlobalMicControl.cpp : Defines the class behaviors for the application.
//
...
// CGlobalMicControlApp construction

CGlobalMicControlApp::CGlobalMicControlApp()
{
...
// The one and only CGlobalMicControlApp object

CGlobalMicControlApp theApp;


// CGlobalMicControlApp initialization
...
BOOL CGlobalMicControlApp::InitInstance()
{
	...
	SetRegistryKey(_T("GlobalMicControl"));
